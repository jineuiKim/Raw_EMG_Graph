...
c1 = dataset.iloc[9900:10800,1]
c1_avg = np.sqrt(np.mean(c1**2))
c2 = dataset.iloc[9900:10800,2]
c2_Avg = np.sqrt(np.mean(c2**2))
c3 = dataset.iloc[9900:10800,3]
c3_Avg = np.sqrt(np.mean(c3**2))
c4 = dataset.iloc[9900:10800,4]
c4_Avg = np.sqrt(np.mean(c4**2))
c5 = dataset.iloc[9900:10800,5]
c5_avg = np.sqrt(np.mean(c5**2))
c6 = dataset.iloc[9900:10800,6]
c6_Avg = np.sqrt(np.mean(c6**2))
c7 = dataset.iloc[9900:10800,7]
c7_Avg = np.sqrt(np.mean(c7**2))
c8 = dataset.iloc[9900:10800,8]
